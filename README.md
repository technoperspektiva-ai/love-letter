...
# Love Letter 1.7.1 — Wizard overlap fix

Що виправлено:
- у режимі створення листа app shell тепер повністю ховається;
- нижня навігація більше не може накладатися на кнопки майстра;
- верхній bar застосунку теж не перетинається з wizard screen;
- action area майстра отримала окремий safe-area padding;
- cache version оновлено до `1.7.1`.

Перевірка:
- відкрий `#create`;
- глобальна нижня навігація не повинна бути видимою;
- залишаються тільки крок, прогрес і кнопки `Назад / Продовжити`.
